...
| `--moe-backend` | `epmoe` | `epmoe` / `fused` / `auto` | Scale-dependent. At EP≤8 (single host v7x-8) `epmoe` wins on MiMo-V2-Flash; at EP≥16 (multi-node) `fused` wins. See [MiMo-V2-Flash recipe](../autoregressive/mimo-v2-flash.md) for measured numbers. |
...
|---|---|
| `mimo` (reasoning + tool) | [`mimo-v2.5-pro.md`](../autoregressive/mimo-v2.5-pro.md) · [`mimo-v2-flash.md`](../autoregressive/mimo-v2-flash.md) · [`mimo-7b.md`](../autoregressive/mimo-7b.md) |
| `deepseek-r1` (reasoning) | [`deepseek-v3.md`](../autoregressive/deepseek-v3.md) (R1 / V3.2-Speciale) |
| `glm45` (reasoning + tool) | [`glm4-moe.md`](../autoregressive/glm4-moe.md) (GLM-4.5 / 4.6) |
| `glm47` (tool) | [`glm5-moe.md`](../autoregressive/glm5-moe.md) (GLM-5 family) |
...
For complete request/response examples see [`mimo-v2.5-pro.md` §5.2](../autoregressive/mimo-v2.5-pro.md#52-reasoning-thinking-enabled) (reasoning streaming) and [§5.3](../autoregressive/mimo-v2.5-pro.md#53-tool-calling) (tool calling).
