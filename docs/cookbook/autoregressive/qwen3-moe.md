...
For GKE, adapt the manifest pattern from [`mimo-v2.5-pro.md` §2.3 Multi-host](mimo-v2.5-pro.md#23-launch) with `<JOB>=qwen3-moe`, `<ACCELERATOR>=tpu-v6e-slice`, the corresponding topology (`4x4` or `8x8`), and the launch flags above.
