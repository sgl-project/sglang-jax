...
> First-generation Qwen recipe. For Qwen3-8B / Qwen3-32B see [`Qwen3.mdx`](Qwen3.mdx).
...
> Qwen-7B-Chat is a first-generation chat model without hybrid reasoning or native tool-calling formats. For reasoning / tool-call workloads use [Qwen3](Qwen3.mdx) or a later Qwen series.
...
- [`Qwen3.mdx`](Qwen3.mdx) — newer Qwen3 8B/32B recipe with framework comparison numbers.
