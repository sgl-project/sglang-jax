...
TUNED_BLOCK_SIZES = {
    ...
    # Ring-1T-FP8: hidden=8192, intermediate=2048, 64 experts, top_k=8, FP8 weights, ep_size=8
    (8192, 2048, 64, 8, 2, 4, 512, 8): (
        64,
        256 * 4,
        256 * 4,
        256 * 8,
