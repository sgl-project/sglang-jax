...
trace_output_dir = os.path.abspath(
    os.path.join(
        os.getenv("PERF_OUTPUT_DIR", "./test/nightly_test_output/perf/local_run"), "model_traces"
    )
)
...
class TestModelPerfTrace(CustomTestCase):
    ...
    def test_qwen_7b_performance_trace_tp_1_daily(self):
        import os
    ...
    def test_qwen_7b_performance_trace_tp_4_daily(self):
        import os
        ...
        process = popen_launch_server(
            ...
            env={
                "JAX_COMPILATION_CACHE_DIR": "/tmp/jax_compilation_cache",
                "SGLANG_JAX_PROFILER_DIR": trace_output_dir + "/" + raw_model_id + self.TP_4,
            },
        )
    ...
    def test_qwen3_8b_performance_trace_tp_1_daily(self):
        import os
    ...
    def test_qwen3_8b_performance_trace_tp_4_daily(self):
        import os
    ...
    def test_QWEN3_MOE_30B_performance_trace_tp_2_ep_2_daily(self):
        import os
        ...
        process = popen_launch_server(
            ...
            env={
                "JAX_COMPILATION_CACHE_DIR": "/tmp/jax_compilation_cache",
                "SGLANG_JAX_PROFILER_DIR": trace_output_dir + "/" + raw_model_id + self.TP_2_EP_2,
            },
        )
    ...
    def test_GEMMA2_2B_IT_performance_trace_tp_1_daily(self):
        import os
    ...
    def test_GEMMA2_2B_IT_performance_trace_tp_4_daily(self):
        import os
    ...
    def test_bailing_moe_performance_trace_tp_2_ep_2_daily(self):
        import os
    ...
    def test_QWEN2_5_7B_INSTRUCT_performance_trace_tp_1_daily(self):
        import os
    ...
    def test_QWEN2_5_7B_INSTRUCT_performance_trace_tp_4_daily(self):
        import os
