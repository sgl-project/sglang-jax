...
You are a helpful assistant.""",
    ...
    #                     "Output format:\n"
    #                     "<json>{<valid JSON object matching schema>}</json>\n\n"
    #                     "Here is an example:\n"
    #                     "<json>{\"name\":\"Paris\",\"population\":2148000}</json>\n\n"
    #                     "Return only the result in the same format; do not output anything else."
    #                 ),
    #             },
    ...
    #     self.assertIsNotNone(m, f"Tagged JSON not found in: {text}")
    #     inner = m.group(1).strip()
    #     try:
    #         js_obj = json.loads(inner)
    #     except (TypeError, json.decoder.JSONDecodeError):
    #         print("JSONDecodeError", inner)
    #         raise
