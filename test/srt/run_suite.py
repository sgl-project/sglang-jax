...
suites = {
    ...
    "unit-test-tpu-v6e-1": [
        TestFile("python/sgl_jax/test/kernels/quantized_linear_test.py", 1, runner="pytest"),
        TestFile("python/sgl_jax/test/kernels/moe_block_quant_test.py", 1, runner="pytest"),
        TestFile("python/sgl_jax/test/test_flashattention.py", 23),
