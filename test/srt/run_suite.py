...
suites = {
    ...
    "e2e-test-tpu-v6e-1": [
        ...
        TestFile("test/srt/test_penalty.py", 20),
        TestFile("test/srt/test_qwen1_5_models_dummy.py", 3),
        TestFile("test/srt/lora/test_bgmv_backend.py", 15),
        TestFile("test/srt/lora/test_dynamic_lora.py", 35),
        TestFile("test/srt/lora/test_static_lora.py", 25),
    ],
    "e2e-test-tpu-v6e-4": [
