...
suites = {
    ...
    "unit-test-tpu-v6e-1": [
        ...
        TestFile("python/sgl_jax/test/multimodal/test_flow_match_euler_discrete_scheduler.py", 1),
        TestFile("python/sgl_jax/test/multimodal/test_flux_transformer_2d_weight_loading.py", 2),
        TestFile("python/sgl_jax/test/multimodal/encoders/test_clip_text_model.py", 3),
        TestFile("python/sgl_jax/test/multimodal/encoders/test_t5_encoder.py", 3),
