...
suites = {
    ...
    "nightly-test-perf-trace-text-models-tpu-v6e-1": [
        TestFile(
            ...
            estimated_time=7,
            test_methods=["TestModePerfTrace.test_qwen_7b_performance_trace_tp_1"],
        ),
        TestFile(
            "nightly-test/test_pref_trace.py",
            estimated_time=8,
            test_methods=["TestModePerfTrace.test_qwen3_8b_performance_trace_tp_1"],
        ),
        TestFile(
            "nightly-test/test_pref_trace.py",
            estimated_time=2,
            test_methods=["TestModePerfTrace.test_GEMMA2_2B_IT_performance_trace_tp_1"],
        ),
        TestFile(
            "nightly-test/test_pref_trace.py",
            estimated_time=2.5,
            test_methods=["TestModePerfTrace.test_QWEN2_5_7B_INSTRUCT_performance_trace_tp_1"],
        ),
    ],
    "nightly-test-perf-trace-text-models-tpu-v6e-4": [
        TestFile(
            "nightly-test/test_pref_trace.py",
            estimated_time=7,
            test_methods=["TestModePerfTrace.test_qwen_7b_performance_trace_tp_4"],
        ),
        TestFile(
            "nightly-test/test_pref_trace.py",
            estimated_time=8,
            test_methods=["TestModePerfTrace.test_qwen3_8b_performance_trace_tp_4"],
        ),
        TestFile(
            "nightly-test/test_pref_trace.py",
            estimated_time=30,
            test_methods=["TestModePerfTrace.test_QWEN3_MOE_30B_performance_trace_tp_2_ep_2"],
        ),
        TestFile(
            "nightly-test/test_pref_trace.py",
            estimated_time=2,
            test_methods=["TestModePerfTrace.test_GEMMA2_2B_IT_performance_trace_tp_4"],
        ),
        TestFile(
            "nightly-test/test_pref_trace.py",
            estimated_time=20,
            test_methods=["TestModePerfTrace.test_bailing_moe_performance_trace_tp_2_ep_2"],
        ),
        TestFile(
            "nightly-test/test_pref_trace.py",
            estimated_time=2.5,
