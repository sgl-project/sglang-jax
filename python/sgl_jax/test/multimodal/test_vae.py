...
class TestCausalConv3d(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        from sgl_jax.srt.multimodal.models.vaes.wanvae import CausalConv3d
...
class TestRMSNorm(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        from sgl_jax.srt.multimodal.models.vaes.wanvae import RMSNorm
...
class TestResidualBlock(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        from sgl_jax.srt.multimodal.models.vaes.wanvae import ResidualBlock
...
class TestUpDownSample(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        from sgl_jax.srt.multimodal.models.vaes.wanvae import (
            Downsample2d,
            Downsample3d,
            Upsample2d,
            Upsample3d,
