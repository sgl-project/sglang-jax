...
class FlashAttention(AttentionBackend):
    ...
    def get_forward_metadata(
        ...
        if swa_page_indices is not None:
            (
                ...
                (num_seqs, cu_q_lens, cu_kv_lens, page_indices, seq_lens, distribution, swa_page_indices),
    ...
    def __call__(
        ...
        if self.forward_metadata.swa_page_indices is not None and hasattr(token_to_kv_pool, "layers_mapping"):
