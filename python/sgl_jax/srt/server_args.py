    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "'cache_aware' strictly prioritizes the longest cached prefix and "
                "breaks equal-match ties by load; it falls back to shape-aware "
                "balancing only when no eligible rank has a cache hit. This keeps "
                "multi-turn agent sessions sticky under DP. "
