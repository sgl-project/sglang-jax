    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "'auto' uses decode-equivalent verify for greedy Step3p5 requests; "
                "'batched' uses the faster batched verify path; 'decode-loop' "
                "explicitly requests the decode-equivalent path."
            ),
        )
