...
class ChunkCache(BasePrefixCache):
    ...
    def match_prefix(self, **unused_kwargs) -> MatchResult:
        return MatchResult(
            device_indices=jnp.empty((0,), dtype=jnp.int64),
    ...
    def pretty_print(self):
        return "ChunkCache: Simple cache for chunked prefill"
...
class SWAChunkCache(ChunkCache):
    ...
    def evict_swa(
        ...
        """Handle SWA eviction for chunked requests"""
    ...
    def evict(self, num_tokens: int):
        # SWA-specific eviction logic could go here
        pass