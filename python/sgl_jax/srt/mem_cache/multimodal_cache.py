...
def _get_tensor_size(embedding: jax.Array):
    """Calculate the size of a JAX array in bytes."""
    return embedding.dtype.itemsize * embedding.size
...
class MultiModalStaticCache(MultimodalCache):
    ...
    def __init__(
        ...
        self.mm_cache: OrderedDict[int, jax.Array] = OrderedDict()
        self.current_size = 0
    ...
    def set(
        self, mm_hash: int, embedding: jax.Array, loc: Optional[jax.Array] = None
    ) -> bool:
