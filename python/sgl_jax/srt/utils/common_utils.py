...
# --- relocated from sgl_jax.srt.multimodal for srt<->multimodal decoupling (refactor M1) ---
# Generic, multimodal-agnostic utilities. Homing them in srt lets srt code use them
# without importing the multimodal package, flipping the dependency graph to a DAG.
