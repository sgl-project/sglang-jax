...
from sgl_jax.srt.utils import jax_utils as jax_utils
from sgl_jax.srt.utils import file_utils
...
class WeightLoader(abc.ABC):
    ...
    Args:
        model_config (ModelConfig): The SGLang model configuration object.
...
def load_hf_weights(model_config: ModelConfig,  model: nnx.Module, mappings: Dict[str, str],
                    mesh: Mesh):
    ...
    head_dim = jax_utils.get_padded_head_dim(head_dim_original)
