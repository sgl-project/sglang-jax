...
class LoRARegistry:
    ...
    def __init__(self, lora_paths: list[LoRARef] | None = None):
        assert lora_paths is None or all(isinstance(lora, LoRARef) for lora in lora_paths), (
    ...
    async def release(self, lora_id: str | list[str]):
        """
