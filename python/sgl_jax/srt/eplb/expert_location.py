...
class ExpertLocationMetadata:
    ...
    def __init__(
        ...
        self.logical_to_rank_dispatch_physical_map = logical_to_rank_dispatch_physical_map
        self.logical_to_all_physical_map = logical_to_all_physical_map
        self.logical_to_all_physical_map_num_valid = logical_to_all_physical_map_num_valid
