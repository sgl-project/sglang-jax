...
def create_audio_tower_weight_mappings(config: Qwen3OmniMoeAudioEncoderConfig) -> dict:
    mappings = {}
...
def create_visual_weight_mappings(config: Qwen3OmniMoeVisionEncoderConfig) -> dict:
