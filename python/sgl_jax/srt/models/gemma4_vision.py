...
class Gemma4AttentionMetadata:
    cu_seqlens: np.ndarray | jax.Array
    max_seq_len: int
...
class Gemma4VisionMetadata:
    ...
    position_ids: np.ndarray | jax.Array  # int32[B, patch_capacity, 2]
    pool_indices: np.ndarray | jax.Array  # int32[B, patch_capacity], -1 for padding
