...
MAX_PIXELS = (
    1280 * 720 * IMAGE_FACTOR
)  # Assume max image pixels is 1280x720, can be adjusted per requirements
MAX_RATIO = 200
RESIZE_RESAMPLE = Image.BILINEAR  # Use common bilinear interpolation as default
VIDEO_TOTAL_PIXELS = int(
    128000 * 28 * 28 * 0.9
)  # Keep original calculation logic but remove environment variable dependency
VIDEO_MIN_PIXELS = 128 * 28 * 28  # 100352
VIDEO_MAX_PIXELS = 768 * 28 * 28  # 602112
FRAME_FACTOR = 2
FPS = 2.0
FPS_MIN_FRAMES = 4
FPS_MAX_FRAMES = 768
...
class QwenVLImageProcessor(SGLangJaxBaseProcessor):
    models = [
    ...
    def __init__(self, hf_config, server_args, _processor, *args, **kwargs):
        ...
        self.mm_tokens = MultimodalSpecialTokens(
            ...
            # Regex to match extended image tokens
    ...
    async def process_mm_data_async(
        ...
        **kwargs,
        ...
        if self.model_type == "qwen3_omni_moe":
            ...
            if audio_item:
                audio_feature_lengths = jnp.sum(audio_item.feature_attention_mask, axis=1)
        ...
        mrope_positions, mrope_position_delta = MRotaryEmbedding.get_rope_index(
            ...
            input_ids=jnp.expand_dims(input_ids, 0),  # Use JAX array
        ...
        # Extract image_grid_thw and video_grid_thw from ret
        image_grid_thw = getattr(ret, "image_grid_thw", None)
        video_grid_thw = getattr(ret, "video_grid_thw", None)
