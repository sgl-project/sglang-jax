...
TUNED_BLOCK_SIZES_RAW = {
    ...
    (6, 1, 2048, 6144, "bfloat16", "float8_e4m3fn"): (1, 2048, 1024),
    (6, 1, 256, 2048, "bfloat16", "float8_e4m3fn"): (8, 256, 256),
    (6, 1, 4096, 2048, "bfloat16", "float8_e4m3fn"): (1, 2048, 1024),
    (6, 1, 576, 6144, "bfloat16", "float8_e4m3fn"): (1, 256, 1024),
    (6, 1, 6144, 2048, "bfloat16", "float8_e4m3fn"): (1, 512, 1024),
    (6, 1, 6144, 256, "bfloat16", "float8_e4m3fn"): (8, 1024, 256),
    (6, 1, 256, 7168, "bfloat16", "float8_e4m3fn"): (8, 256, 1024),
    (6, 1, 576, 7168, "bfloat16", "float8_e4m3fn"): (8, 512, 512),
    (6, 1, 1536, 7168, "bfloat16", "float8_e4m3fn"): (8, 512, 1024),
    (6, 1, 2304, 7168, "bfloat16", "float8_e4m3fn"): (8, 256, 1024),
    (6, 1, 3072, 1536, "bfloat16", "float8_e4m3fn"): (8, 512, 256),
    (6, 1, 4096, 512, "bfloat16", "float8_e4m3fn"): (8, 1024, 128),
    (6, 1, 7168, 256, "bfloat16", "float8_e4m3fn"): (8, 2048, 128),
    (6, 1, 7168, 2048, "bfloat16", "float8_e4m3fn"): (8, 512, 2048),
    (6, 1, 7168, 2304, "bfloat16", "float8_e4m3fn"): (8, 1024, 256),
    (6, 8, 256, 7168, "bfloat16", "float8_e4m3fn"): (8, 256, 256),
    (6, 8, 576, 7168, "bfloat16", "float8_e4m3fn"): (8, 512, 512),
    (6, 8, 1536, 7168, "bfloat16", "float8_e4m3fn"): (8, 512, 1024),
    (6, 8, 2304, 7168, "bfloat16", "float8_e4m3fn"): (8, 256, 1024),
    (6, 8, 3072, 1536, "bfloat16", "float8_e4m3fn"): (8, 512, 256),
    (6, 8, 4096, 512, "bfloat16", "float8_e4m3fn"): (8, 1024, 512),
    (6, 8, 7168, 256, "bfloat16", "float8_e4m3fn"): (8, 256, 128),
    (6, 8, 7168, 2048, "bfloat16", "float8_e4m3fn"): (8, 1024, 2048),
    (6, 8, 7168, 2304, "bfloat16", "float8_e4m3fn"): (8, 1024, 256),
    (6, 32, 256, 7168, "bfloat16", "float8_e4m3fn"): (32, 256, 512),
    (6, 32, 576, 7168, "bfloat16", "float8_e4m3fn"): (32, 512, 512),
    (6, 32, 1536, 7168, "bfloat16", "float8_e4m3fn"): (32, 512, 1024),
    (6, 32, 2304, 7168, "bfloat16", "float8_e4m3fn"): (32, 256, 1024),
    (6, 32, 3072, 1536, "bfloat16", "float8_e4m3fn"): (32, 1024, 256),
    (6, 32, 4096, 512, "bfloat16", "float8_e4m3fn"): (16, 4096, 512),
    (6, 32, 7168, 256, "bfloat16", "float8_e4m3fn"): (16, 1024, 256),
    (6, 32, 7168, 2048, "bfloat16", "float8_e4m3fn"): (32, 512, 1024),
    (6, 32, 7168, 2304, "bfloat16", "float8_e4m3fn"): (32, 1024, 256),
    (6, 64, 256, 7168, "bfloat16", "float8_e4m3fn"): (64, 256, 512),
    (6, 64, 576, 7168, "bfloat16", "float8_e4m3fn"): (64, 512, 1024),
    (6, 64, 1536, 7168, "bfloat16", "float8_e4m3fn"): (64, 512, 1024),
    (6, 64, 2304, 7168, "bfloat16", "float8_e4m3fn"): (64, 256, 1024),
    (6, 64, 3072, 1536, "bfloat16", "float8_e4m3fn"): (64, 256, 512),
    (6, 64, 4096, 512, "bfloat16", "float8_e4m3fn"): (16, 4096, 512),
    (6, 64, 7168, 256, "bfloat16", "float8_e4m3fn"): (64, 256, 256),
    (6, 64, 7168, 2048, "bfloat16", "float8_e4m3fn"): (32, 1024, 2048),
    (6, 64, 7168, 2304, "bfloat16", "float8_e4m3fn"): (64, 1024, 256),
    (6, 2048, 256, 7168, "bfloat16", "float8_e4m3fn"): (2048, 256, 512),
    (6, 2048, 576, 7168, "bfloat16", "float8_e4m3fn"): (2048, 256, 1024),
    (6, 2048, 1536, 7168, "bfloat16", "float8_e4m3fn"): (2048, 512, 512),
    (6, 2048, 2304, 7168, "bfloat16", "float8_e4m3fn"): (2048, 256, 1024),
    (6, 2048, 3072, 1536, "bfloat16", "float8_e4m3fn"): (2048, 1024, 512),
    (6, 2048, 4096, 512, "bfloat16", "float8_e4m3fn"): (512, 2048, 256),
    (6, 2048, 7168, 256, "bfloat16", "float8_e4m3fn"): (2048, 256, 256),
    (6, 2048, 7168, 2048, "bfloat16", "float8_e4m3fn"): (512, 1024, 2048),
    (6, 2048, 7168, 2304, "bfloat16", "float8_e4m3fn"): (2048, 1024, 128),
    # ===== DeepSeek-V3 on TPU v7x (tensor=8, dp=4 → per-shard n_batch ∈
    # {16,32,64,128,2048}). First 18 entries swept on v7x-16 2026-06-06; the
    # rest reuse v6e values (nearest n_batch) pending a full v7x sweep.
    (7, 16, 1536, 7168, "bfloat16", "float8_e4m3fn"): (16, 256, 2048),
    (7, 32, 1536, 7168, "bfloat16", "float8_e4m3fn"): (16, 256, 4096),
    (7, 64, 1536, 7168, "bfloat16", "float8_e4m3fn"): (64, 512, 512),
    (7, 128, 1536, 7168, "bfloat16", "float8_e4m3fn"): (32, 256, 4096),
    (7, 2048, 1536, 7168, "bfloat16", "float8_e4m3fn"): (1024, 512, 256),
    (7, 16, 3072, 1536, "bfloat16", "float8_e4m3fn"): (16, 1024, 256),
    (7, 32, 3072, 1536, "bfloat16", "float8_e4m3fn"): (32, 1024, 256),
    (7, 64, 3072, 1536, "bfloat16", "float8_e4m3fn"): (32, 2048, 128),
    (7, 128, 3072, 1536, "bfloat16", "float8_e4m3fn"): (128, 2048, 256),
    (7, 2048, 3072, 1536, "bfloat16", "float8_e4m3fn"): (1024, 256, 1024),
    (7, 16, 576, 7168, "bfloat16", "float8_e4m3fn"): (16, 256, 512),
    (7, 32, 576, 7168, "bfloat16", "float8_e4m3fn"): (16, 256, 2048),
    (7, 64, 576, 7168, "bfloat16", "float8_e4m3fn"): (32, 256, 4096),
    (7, 128, 576, 7168, "bfloat16", "float8_e4m3fn"): (32, 256, 2048),
    (7, 2048, 576, 7168, "bfloat16", "float8_e4m3fn"): (2048, 256, 512),
    (7, 16, 4096, 512, "bfloat16", "float8_e4m3fn"): (16, 1024, 256),
    (7, 32, 4096, 512, "bfloat16", "float8_e4m3fn"): (32, 512, 256),
    (7, 64, 4096, 512, "bfloat16", "float8_e4m3fn"): (32, 2048, 128),
    (7, 128, 4096, 512, "bfloat16", "float8_e4m3fn"): (16, 4096, 512),
    (7, 2048, 4096, 512, "bfloat16", "float8_e4m3fn"): (512, 2048, 256),
    (7, 16, 7168, 2048, "bfloat16", "float8_e4m3fn"): (16, 1024, 2048),
    (7, 32, 7168, 2048, "bfloat16", "float8_e4m3fn"): (32, 512, 1024),
    (7, 64, 7168, 2048, "bfloat16", "float8_e4m3fn"): (32, 1024, 2048),
    (7, 128, 7168, 2048, "bfloat16", "float8_e4m3fn"): (32, 1024, 2048),
    (7, 2048, 7168, 2048, "bfloat16", "float8_e4m3fn"): (512, 1024, 2048),
    (7, 16, 2304, 7168, "bfloat16", "float8_e4m3fn"): (16, 256, 1024),
    (7, 32, 2304, 7168, "bfloat16", "float8_e4m3fn"): (32, 256, 1024),
    (7, 64, 2304, 7168, "bfloat16", "float8_e4m3fn"): (64, 256, 1024),
    (7, 128, 2304, 7168, "bfloat16", "float8_e4m3fn"): (64, 256, 1024),
    (7, 2048, 2304, 7168, "bfloat16", "float8_e4m3fn"): (2048, 256, 1024),
    (7, 16, 7168, 2304, "bfloat16", "float8_e4m3fn"): (16, 1024, 256),
    (7, 32, 7168, 2304, "bfloat16", "float8_e4m3fn"): (32, 1024, 256),
    (7, 64, 7168, 2304, "bfloat16", "float8_e4m3fn"): (64, 1024, 256),
    (7, 128, 7168, 2304, "bfloat16", "float8_e4m3fn"): (64, 1024, 256),
    (7, 2048, 7168, 2304, "bfloat16", "float8_e4m3fn"): (2048, 1024, 128),
    (7, 16, 256, 7168, "bfloat16", "float8_e4m3fn"): (16, 256, 256),
    (7, 32, 256, 7168, "bfloat16", "float8_e4m3fn"): (32, 256, 512),
    (7, 64, 256, 7168, "bfloat16", "float8_e4m3fn"): (64, 256, 512),
    (7, 128, 256, 7168, "bfloat16", "float8_e4m3fn"): (64, 256, 512),
    (7, 2048, 256, 7168, "bfloat16", "float8_e4m3fn"): (2048, 256, 512),
    (7, 16, 7168, 256, "bfloat16", "float8_e4m3fn"): (16, 256, 128),
    (7, 32, 7168, 256, "bfloat16", "float8_e4m3fn"): (16, 1024, 256),
    (7, 64, 7168, 256, "bfloat16", "float8_e4m3fn"): (64, 256, 256),
    (7, 128, 7168, 256, "bfloat16", "float8_e4m3fn"): (64, 256, 256),
    (7, 2048, 7168, 256, "bfloat16", "float8_e4m3fn"): (2048, 256, 256),
    ...
    (6, 2048, 2048, 6144, "bfloat16", "float8_e4m3fn"): (256, 2048, 2048),
    (6, 2048, 256, 2048, "bfloat16", "float8_e4m3fn"): (256, 256, 1024),
    ...
    (6, 2048, 4096, 2048, "bfloat16", "float8_e4m3fn"): (2048, 1024, 512),
    ...
    (6, 2048, 576, 6144, "bfloat16", "float8_e4m3fn"): (2048, 512, 1024),
    (6, 2048, 6144, 2048, "bfloat16", "float8_e4m3fn"): (2048, 2048, 128),
    (6, 2048, 6144, 256, "bfloat16", "float8_e4m3fn"): (2048, 1024, 128),
    ...
    (6, 32, 2048, 6144, "bfloat16", "float8_e4m3fn"): (32, 1024, 2048),
    (6, 32, 256, 2048, "bfloat16", "float8_e4m3fn"): (32, 256, 512),
    ...
    (6, 32, 4096, 2048, "bfloat16", "float8_e4m3fn"): (16, 4096, 2048),
    ...
    (6, 32, 576, 6144, "bfloat16", "float8_e4m3fn"): (16, 256, 2048),
    (6, 32, 6144, 2048, "bfloat16", "float8_e4m3fn"): (16, 2048, 2048),
    (6, 32, 6144, 256, "bfloat16", "float8_e4m3fn"): (16, 4096, 128),
    ...
    (6, 64, 2048, 6144, "bfloat16", "float8_e4m3fn"): (32, 2048, 1024),
    (6, 64, 256, 2048, "bfloat16", "float8_e4m3fn"): (64, 256, 512),
    ...
    (6, 64, 4096, 2048, "bfloat16", "float8_e4m3fn"): (32, 4096, 2048),
    ...
    (6, 64, 576, 6144, "bfloat16", "float8_e4m3fn"): (64, 512, 512),
    (6, 64, 6144, 2048, "bfloat16", "float8_e4m3fn"): (64, 1024, 1024),
    (6, 64, 6144, 256, "bfloat16", "float8_e4m3fn"): (64, 1024, 256),
    ...
    (6, 8, 2048, 6144, "bfloat16", "float8_e4m3fn"): (8, 512, 2048),
    (6, 8, 256, 2048, "bfloat16", "float8_e4m3fn"): (8, 256, 256),
    (6, 8, 4096, 2048, "bfloat16", "float8_e4m3fn"): (8, 1024, 1024),
    (6, 8, 576, 6144, "bfloat16", "float8_e4m3fn"): (8, 512, 1024),
    (6, 8, 6144, 2048, "bfloat16", "float8_e4m3fn"): (8, 2048, 1024),
    (6, 8, 6144, 256, "bfloat16", "float8_e4m3fn"): (8, 4096, 256),
    ...
    (7, 1024, 14336, 4096, "float8_e4m3fn", "float8_e4m3fn"): (1024, 1792, 4096),
    (7, 1024, 25600, 5120, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 2560, 1),
    (7, 1024, 25600, 5120, "float8_e4m3fn", "float8_e4m3fn"): (512, 6400, 1024, 1),
    (7, 1024, 28672, 8192, "float8_e4m3fn", "float8_e4m3fn"): (512, 1024, 8192),
    (7, 1024, 3072, 4096, "float8_e4m3fn", "float8_e4m3fn"): (1024, 3072, 1024),
    (7, 1024, 4096, 2048, "float8_e4m3fn", "float8_e4m3fn"): (1024, 1024, 2048),
    (7, 1024, 4096, 7168, "float8_e4m3fn", "float8_e4m3fn"): (1024, 4096, 1024),
    (7, 1024, 5120, 12800, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 2560, 4),
    (7, 1024, 5120, 12800, "float8_e4m3fn", "float8_e4m3fn"): (1024, 5120, 512, 1),
    (7, 1024, 5120, 25600, "float8_e4m3fn", "float8_e4m3fn"): (1024, 2560, 2560),
    (7, 1024, 5120, 4096, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 1024, 4),
    (7, 1024, 5120, 4096, "float8_e4m3fn", "float8_e4m3fn"): (256, 5120, 4096, 2),
    (7, 1024, 5120, 5120, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 1024, 4),
    (7, 1024, 5120, 5120, "float8_e4m3fn", "float8_e4m3fn"): (1024, 5120, 512, 4),
    (7, 1024, 5120, 8192, "float8_e4m3fn", "float8_e4m3fn"): (512, 5120, 2048),
    (7, 1024, 8192, 14336, "float8_e4m3fn", "float8_e4m3fn"): (1024, 2048, 2048),
    (7, 1024, 8192, 4096, "float8_e4m3fn", "float8_e4m3fn"): (1024, 1024, 4096),
    (7, 128, 14336, 4096, "float8_e4m3fn", "float8_e4m3fn"): (128, 3584, 4096),
    (7, 128, 25600, 5120, "float8_e4m3fn", "float4_e2m1fn"): (128, 5120, 2560, 2),
    (7, 128, 25600, 5120, "float8_e4m3fn", "float8_e4m3fn"): (128, 1024, 2560, 1),
    ...
    (7, 128, 5120, 12800, "float8_e4m3fn", "float4_e2m1fn"): (128, 5120, 2560, 2),
    (7, 128, 5120, 12800, "float8_e4m3fn", "float8_e4m3fn"): (128, 1024, 2560, 4),
    (7, 128, 5120, 25600, "float8_e4m3fn", "float8_e4m3fn"): (128, 512, 25600),
    (7, 128, 5120, 4096, "float8_e4m3fn", "float4_e2m1fn"): (128, 2560, 2048, 1),
    (7, 128, 5120, 4096, "float8_e4m3fn", "float8_e4m3fn"): (128, 5120, 1024, 1),
    (7, 128, 5120, 5120, "float8_e4m3fn", "float4_e2m1fn"): (128, 5120, 1024, 4),
    (7, 128, 5120, 5120, "float8_e4m3fn", "float8_e4m3fn"): (128, 5120, 2560, 1),
    (7, 128, 5120, 8192, "float8_e4m3fn", "float8_e4m3fn"): (128, 5120, 2048),
    (7, 128, 8192, 14336, "float8_e4m3fn", "float8_e4m3fn"): (128, 1024, 14336),
    (7, 128, 8192, 4096, "float8_e4m3fn", "float8_e4m3fn"): (128, 4096, 4096),
    (7, 16, 14336, 4096, "float8_e4m3fn", "float8_e4m3fn"): (16, 3584, 4096),
    (7, 16, 25600, 5120, "float8_e4m3fn", "float4_e2m1fn"): (16, 12800, 1024, 2),
    (7, 16, 25600, 5120, "float8_e4m3fn", "float8_e4m3fn"): (16, 1024, 5120, 2),
    ...
    (7, 16, 5120, 12800, "float8_e4m3fn", "float4_e2m1fn"): (16, 1024, 12800, 2),
    ...
    (7, 2048, 14336, 4096, "float8_e4m3fn", "float8_e4m3fn"): (1024, 2048, 4096),
    (7, 2048, 25600, 5120, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 2560, 2),
    (7, 2048, 25600, 5120, "float8_e4m3fn", "float8_e4m3fn"): (1024, 5120, 512, 4),
    (7, 2048, 28672, 8192, "float8_e4m3fn", "float8_e4m3fn"): (1024, 4096, 1024),
    (7, 2048, 3072, 4096, "float8_e4m3fn", "float8_e4m3fn"): (1024, 1536, 4096),
    (7, 2048, 4096, 2048, "float8_e4m3fn", "float8_e4m3fn"): (1024, 2048, 2048),
    (7, 2048, 4096, 7168, "float8_e4m3fn", "float8_e4m3fn"): (1024, 4096, 1024),
    (7, 2048, 5120, 12800, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 2560, 2),
    (7, 2048, 5120, 12800, "float8_e4m3fn", "float8_e4m3fn"): (512, 2560, 2560, 2),
    (7, 2048, 5120, 25600, "float8_e4m3fn", "float8_e4m3fn"): (1024, 2560, 2560),
    (7, 2048, 5120, 4096, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 4096, 2),
    (7, 2048, 5120, 4096, "float8_e4m3fn", "float8_e4m3fn"): (256, 5120, 4096, 2),
    (7, 2048, 5120, 5120, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 2560, 2),
    (7, 2048, 5120, 5120, "float8_e4m3fn", "float8_e4m3fn"): (1024, 5120, 512, 4),
    (7, 2048, 5120, 8192, "float8_e4m3fn", "float8_e4m3fn"): (1024, 2560, 2048),
    (7, 2048, 8192, 14336, "float8_e4m3fn", "float8_e4m3fn"): (1024, 4096, 1024),
    (7, 2048, 8192, 4096, "float8_e4m3fn", "float8_e4m3fn"): (1024, 2048, 4096),
    (7, 256, 14336, 4096, "float8_e4m3fn", "float8_e4m3fn"): (256, 2048, 4096),
    (7, 256, 25600, 5120, "float8_e4m3fn", "float4_e2m1fn"): (256, 25600, 512, 1),
    (7, 256, 25600, 5120, "float8_e4m3fn", "float8_e4m3fn"): (256, 2560, 2560, 1),
    ...
    (7, 256, 5120, 12800, "float8_e4m3fn", "float4_e2m1fn"): (256, 5120, 2560, 4),
    (7, 256, 5120, 12800, "float8_e4m3fn", "float8_e4m3fn"): (256, 5120, 512, 2),
    (7, 256, 5120, 25600, "float8_e4m3fn", "float8_e4m3fn"): (256, 5120, 2560),
    (7, 256, 5120, 4096, "float8_e4m3fn", "float4_e2m1fn"): (256, 2560, 1024, 2),
    (7, 256, 5120, 4096, "float8_e4m3fn", "float8_e4m3fn"): (128, 5120, 4096, 4),
    (7, 256, 5120, 5120, "float8_e4m3fn", "float4_e2m1fn"): (256, 5120, 2560, 2),
    (7, 256, 5120, 5120, "float8_e4m3fn", "float8_e4m3fn"): (256, 2560, 2560, 1),
    ...
    (7, 32, 25600, 5120, "float8_e4m3fn", "float4_e2m1fn"): (32, 2560, 5120, 1),
    (7, 32, 25600, 5120, "float8_e4m3fn", "float8_e4m3fn"): (32, 25600, 512, 2),
    ...
    (7, 32, 5120, 12800, "float8_e4m3fn", "float4_e2m1fn"): (32, 5120, 2560, 2),
    (7, 32, 5120, 12800, "float8_e4m3fn", "float8_e4m3fn"): (32, 2560, 2560, 2),
    ...
    (7, 4096, 14336, 4096, "float8_e4m3fn", "float8_e4m3fn"): (512, 3584, 4096),
    (7, 4096, 25600, 5120, "float8_e4m3fn", "float4_e2m1fn"): (512, 6400, 512, 1),
    (7, 4096, 25600, 5120, "float8_e4m3fn", "float8_e4m3fn"): (512, 6400, 512, 1),
    (7, 4096, 28672, 8192, "float8_e4m3fn", "float8_e4m3fn"): (512, 1024, 8192),
    (7, 4096, 3072, 4096, "float8_e4m3fn", "float8_e4m3fn"): (512, 3072, 4096),
    (7, 4096, 4096, 2048, "float8_e4m3fn", "float8_e4m3fn"): (512, 4096, 2048),
    (7, 4096, 4096, 7168, "float8_e4m3fn", "float8_e4m3fn"): (1024, 4096, 1024),
    (7, 4096, 5120, 12800, "float8_e4m3fn", "float4_e2m1fn"): (1024, 2560, 2560, 1),
    (7, 4096, 5120, 12800, "float8_e4m3fn", "float8_e4m3fn"): (256, 5120, 2560, 1),
    (7, 4096, 5120, 25600, "float8_e4m3fn", "float8_e4m3fn"): (1024, 2560, 2560),
    (7, 4096, 5120, 4096, "float8_e4m3fn", "float4_e2m1fn"): (256, 5120, 4096, 4),
    (7, 4096, 5120, 4096, "float8_e4m3fn", "float8_e4m3fn"): (256, 5120, 4096, 1),
    (7, 4096, 5120, 5120, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 2560, 4),
    (7, 4096, 5120, 5120, "float8_e4m3fn", "float8_e4m3fn"): (256, 5120, 5120, 4),
    (7, 4096, 5120, 8192, "float8_e4m3fn", "float8_e4m3fn"): (1024, 2560, 2048),
    (7, 4096, 8192, 14336, "float8_e4m3fn", "float8_e4m3fn"): (1024, 4096, 1024),
    (7, 4096, 8192, 4096, "float8_e4m3fn", "float8_e4m3fn"): (1024, 1024, 4096),
    (7, 512, 14336, 4096, "float8_e4m3fn", "float8_e4m3fn"): (512, 2048, 4096),
    (7, 512, 25600, 5120, "float8_e4m3fn", "float4_e2m1fn"): (512, 12800, 512, 2),
    (7, 512, 25600, 5120, "float8_e4m3fn", "float8_e4m3fn"): (512, 2560, 1024, 1),
    ...
    (7, 512, 5120, 12800, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 512, 1),
    (7, 512, 5120, 12800, "float8_e4m3fn", "float8_e4m3fn"): (512, 5120, 512, 2),
    (7, 512, 5120, 25600, "float8_e4m3fn", "float8_e4m3fn"): (512, 2560, 2560),
    (7, 512, 5120, 4096, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 512, 4),
    (7, 512, 5120, 4096, "float8_e4m3fn", "float8_e4m3fn"): (512, 5120, 1024, 4),
    (7, 512, 5120, 5120, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 512, 2),
    (7, 512, 5120, 5120, "float8_e4m3fn", "float8_e4m3fn"): (512, 5120, 1024, 4),
    ...
    (7, 64, 25600, 5120, "float8_e4m3fn", "float4_e2m1fn"): (64, 2560, 5120, 2),
    (7, 64, 25600, 5120, "float8_e4m3fn", "float8_e4m3fn"): (64, 5120, 1024, 4),
    ...
    (7, 64, 5120, 12800, "float8_e4m3fn", "float4_e2m1fn"): (64, 2560, 2560, 1),
    (7, 64, 5120, 12800, "float8_e4m3fn", "float8_e4m3fn"): (64, 5120, 2560, 1),
    ...
    (7, 8192, 14336, 4096, "float8_e4m3fn", "float8_e4m3fn"): (1024, 1024, 4096),
    (7, 8192, 25600, 5120, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 1024, 4),
    (7, 8192, 25600, 5120, "float8_e4m3fn", "float8_e4m3fn"): (512, 2560, 2560, 2),
    (7, 8192, 28672, 8192, "float8_e4m3fn", "float8_e4m3fn"): (1024, 2048, 2048),
    (7, 8192, 3072, 4096, "float8_e4m3fn", "float8_e4m3fn"): (1024, 1536, 4096),
    (7, 8192, 4096, 2048, "float8_e4m3fn", "float8_e4m3fn"): (512, 4096, 2048),
    (7, 8192, 4096, 7168, "float8_e4m3fn", "float8_e4m3fn"): (1024, 4096, 1024),
    (7, 8192, 5120, 12800, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 2560, 4),
    (7, 8192, 5120, 12800, "float8_e4m3fn", "float8_e4m3fn"): (1024, 5120, 512, 2),
    (7, 8192, 5120, 4096, "float8_e4m3fn", "float4_e2m1fn"): (256, 5120, 4096, 4),
    (7, 8192, 5120, 4096, "float8_e4m3fn", "float8_e4m3fn"): (256, 5120, 4096, 2),
    (7, 8192, 5120, 5120, "float8_e4m3fn", "float4_e2m1fn"): (512, 5120, 2560, 1),
    (7, 8192, 5120, 5120, "float8_e4m3fn", "float8_e4m3fn"): (256, 5120, 5120, 2),
