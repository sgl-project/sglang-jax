...
from sgl_jax.srt.kernels.quantized_matmul import util
from sgl_jax.srt.kernels.quantized_matmul.tuned_block_sizes import (
    TunedValue,
    get_device_vmem_limit,
    get_tuned_block_sizes,
)
from sgl_jax.srt.kernels.quantized_matmul.util import (
    get_kernel_name,
    next_multiple,
    unfold_args,
)
    ...
    *,
    ...
    kernel = pl.pallas_call(
        ...
        grid_spec=pltpu.PrefetchScalarGridSpec(
            ...
            scratch_shapes=[pltpu.VMEM((batch_block_size, out_block_size), jnp.bfloat16)],
