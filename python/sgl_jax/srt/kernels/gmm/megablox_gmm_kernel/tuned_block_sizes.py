...
TUNED_BLOCK_SIZES = {
    ...
    (2, 8192, 2048, 8, 8, "bfloat16", "bfloat16", 8192): (
        2,
        256 * 8,
        256 * 8,
    ),
    (4, 8192, 2048, 8, 8, "bfloat16", "bfloat16", 8192): (
        4,
        256 * 8,
        256 * 8,
    ),
    (8, 8192, 2048, 8, 8, "bfloat16", "bfloat16", 8192): (
        8,
        256 * 16,
        256 * 4,
    ),
    (16, 8192, 2048, 8, 8, "bfloat16", "bfloat16", 8192): (
        16,
        256 * 8,
        256 * 8,
    ),
    (32, 8192, 2048, 8, 8, "bfloat16", "bfloat16", 8192): (
        32,
        256 * 8,
        256 * 8,
    ),
    (64, 8192, 2048, 8, 8, "bfloat16", "bfloat16", 8192): (
        64,
        256 * 8,
        256 * 8,
    ),
    (128, 8192, 2048, 8, 8, "bfloat16", "bfloat16", 8192): (
        128,
        256 * 8,
        256 * 8,
    ),
    (16384, 8192, 2048, 8, 8, "bfloat16", "bfloat16", 8192): (
        256 * 1,
        256 * 8,
        256 * 8,
    ),
    (32768, 8192, 2048, 8, 8, "bfloat16", "bfloat16", 8192): (
        256 * 1,
        256 * 8,
        256 * 8,
    ),
    (2, 2048, 8192, 8, 8, "bfloat16", "bfloat16", 2048): (
        2,
        256 * 8,
        256 * 8,
    ),
    (4, 2048, 8192, 8, 8, "bfloat16", "bfloat16", 2048): (
        4,
        256 * 4,
        256 * 16,
    ),
    (8, 2048, 8192, 8, 8, "bfloat16", "bfloat16", 2048): (
        8,
        256 * 8,
        256 * 8,
    ),
    (16, 2048, 8192, 8, 8, "bfloat16", "bfloat16", 2048): (
        16,
        256 * 4,
        256 * 16,
    ),
    (32, 2048, 8192, 8, 8, "bfloat16", "bfloat16", 2048): (
        32,
        256 * 8,
        256 * 8,
    ),
    (64, 2048, 8192, 8, 8, "bfloat16", "bfloat16", 2048): (
        64,
        256 * 8,
        256 * 8,
    ),
    (128, 2048, 8192, 8, 8, "bfloat16", "bfloat16", 2048): (
        128,
        256 * 8,
        256 * 8,
    ),
    (16384, 2048, 8192, 8, 8, "bfloat16", "bfloat16", 2048): (
        256 * 1,
        256 * 8,
        256 * 8,
    ),
    (32768, 2048, 8192, 8, 8, "bfloat16", "bfloat16", 2048): (
        256 * 1,
        256 * 8,
        256 * 8,
    ),
    (2, 8192, 2048, 8, 8, "bfloat16", "float8_e4m3fn", 8192): (
        2,
        256 * 16,
        256 * 8,
    ),
    (4, 8192, 2048, 8, 8, "bfloat16", "float8_e4m3fn", 8192): (
        4,
        256 * 16,
        256 * 8,
    ),
    (8, 8192, 2048, 8, 8, "bfloat16", "float8_e4m3fn", 8192): (
        8,
        256 * 16,
        256 * 8,
    ),
    (16, 8192, 2048, 8, 8, "bfloat16", "float8_e4m3fn", 8192): (
        16,
        256 * 16,
        256 * 8,
    ),
    (32, 8192, 2048, 8, 8, "bfloat16", "float8_e4m3fn", 8192): (
        32,
        256 * 16,
        256 * 8,
    ),
    (64, 8192, 2048, 8, 8, "bfloat16", "float8_e4m3fn", 8192): (
        64,
        256 * 16,
        256 * 8,
    ),
    (128, 8192, 2048, 8, 8, "bfloat16", "float8_e4m3fn", 8192): (
        128,
        256 * 16,
        256 * 8,
    ),
    (16384, 8192, 2048, 8, 8, "bfloat16", "float8_e4m3fn", 8192): (
        256 * 1,
        256 * 16,
        256 * 8,
    ),
    (32768, 8192, 2048, 8, 8, "bfloat16", "float8_e4m3fn", 8192): (
        256 * 1,
        256 * 16,
        256 * 8,
    ),
    (2, 2048, 8192, 8, 8, "bfloat16", "float8_e4m3fn", 2048): (
        2,
        256 * 8,
        256 * 16,
    ),
    (4, 2048, 8192, 8, 8, "bfloat16", "float8_e4m3fn", 2048): (
        4,
        256 * 8,
        256 * 16,
    ),
    (8, 2048, 8192, 8, 8, "bfloat16", "float8_e4m3fn", 2048): (
        8,
        256 * 8,
        256 * 16,
    ),
    (16, 2048, 8192, 8, 8, "bfloat16", "float8_e4m3fn", 2048): (
        16,
        256 * 8,
        256 * 16,
    ),
    (32, 2048, 8192, 8, 8, "bfloat16", "float8_e4m3fn", 2048): (
        32,
        256 * 8,
        256 * 16,
    ),
    (64, 2048, 8192, 8, 8, "bfloat16", "float8_e4m3fn", 2048): (
        64,
        256 * 8,
        256 * 16,
    ),
    (128, 2048, 8192, 8, 8, "bfloat16", "float8_e4m3fn", 2048): (
        128,
        256 * 8,
        256 * 16,
    ),
    (16384, 2048, 8192, 8, 8, "bfloat16", "float8_e4m3fn", 2048): (
        256 * 1,
        256 * 8,
        256 * 16,
    ),
    (32768, 2048, 8192, 8, 8, "bfloat16", "float8_e4m3fn", 2048): (
        256 * 1,
        256 * 8,
        256 * 16,
    ),
    (2, 8192, 2048, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 8192): (
        2,
        256 * 16,
        256 * 8,
    ),
    (4, 8192, 2048, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 8192): (
        4,
        256 * 16,
        256 * 8,
    ),
    (8, 8192, 2048, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 8192): (
        8,
        256 * 16,
        256 * 8,
    ),
    (16, 8192, 2048, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 8192): (
        16,
        256 * 16,
        256 * 8,
    ),
    (32, 8192, 2048, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 8192): (
        32,
        256 * 16,
        256 * 8,
    ),
    (64, 8192, 2048, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 8192): (
        64,
        256 * 16,
        256 * 8,
    ),
    (128, 8192, 2048, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 8192): (
        128,
        256 * 16,
        256 * 8,
    ),
    (16384, 8192, 2048, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 8192): (
        256 * 1,
        256 * 16,
        256 * 8,
    ),
    (32768, 8192, 2048, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 8192): (
        256 * 1,
        256 * 16,
        256 * 8,
    ),
    (2, 2048, 8192, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 2048): (
        2,
        256 * 8,
        256 * 16,
    ),
    (4, 2048, 8192, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 2048): (
        4,
        256 * 8,
        256 * 16,
    ),
    (8, 2048, 8192, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 2048): (
        8,
        256 * 8,
        256 * 16,
    ),
    (16, 2048, 8192, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 2048): (
        16,
        256 * 8,
        256 * 16,
    ),
    (32, 2048, 8192, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 2048): (
        32,
        256 * 8,
        256 * 16,
    ),
    (64, 2048, 8192, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 2048): (
        64,
        256 * 8,
        256 * 16,
    ),
    (128, 2048, 8192, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 2048): (
        128,
        256 * 8,
        256 * 16,
    ),
    (16384, 2048, 8192, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 2048): (
        256 * 1,
        256 * 8,
        256 * 16,
    ),
    (32768, 2048, 8192, 8, 8, "float8_e4m3fn", "float8_e4m3fn", 2048): (
        256 * 1,
        256 * 8,
        256 * 16,
    ),
