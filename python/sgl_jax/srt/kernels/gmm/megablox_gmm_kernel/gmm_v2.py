...
def gmm_v2(
    ...
    *,
    ...
    if cfgs.zero_init:
        ...
        # zero initializing DMA for up-to tile_zero_m rows. Larger tile_zero_m
        # results in fewer tiles and lower overhead. To avoid OOM, we set column
        # size to num_lanes (smallest allowed DMA column size) and reuse the buffer
        # size_n//num_lanes times per tile.
