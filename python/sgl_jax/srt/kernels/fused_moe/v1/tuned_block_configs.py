...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, ...]]] = {
    ...
    "TPU v7": {
        ...
        # FP8 (sparse_hotspot, hotspot_ratio=1, hotspot_count=48)
        ...
        ('bfloat16', 'float8_e4m3fn', 1024, 256, 8, 4096, 2048, 8, False, False): (128, 2048, 1024, 1024, 64, 64, 2048, 1024, 1024, 2048),
        ...
        ('bfloat16', 'float8_e4m3fn', 32768, 256, 8, 4096, 2048, 8, False, False): (128, 2048, 1024, 1024, 64, 64, 2048, 1024, 1024, 2048),
    },
