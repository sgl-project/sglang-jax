...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, ...]]] = {
    ...
    "TPU v7": {
        ...
        ("bfloat16", 128, 256, 8, 8192, 2048, 8): (
            16,
            1024,
            2048,
            2048,
        ...
        ("bfloat16", 1024, 256, 8, 8192, 2048, 8): (
            64,
            512,
            2048,
            2048,
        ...
        ("bfloat16", 2048, 256, 8, 8192, 2048, 8): (
            64,
            512,
            2048,
            2048,
        ...
        ("bfloat16", 4096, 256, 8, 8192, 2048, 8): (
            64,
            1024,
            1024,
            1024,
        ...
        ("bfloat16", 512, 256, 8, 8192, 2048, 32): (
            16,
            2048,
            1024,
            1024,
        ...
        ("bfloat16", 1024, 256, 8, 8192, 2048, 32): (
            32,
            2048,
            1024,
            1024,
        ...
        ("bfloat16", 2048, 256, 8, 8192, 2048, 32): (64, 2048, 512, 512, 64, 2048, 512, 512, 1024),
        ("bfloat16", 4096, 256, 8, 8192, 2048, 32): (
            128,
            1024,
            1024,
            1024,
        ...
        ("bfloat16", 16, 256, 8, 2048, 512, 8): (2, 512, 1024, 1024, 2, 512, 1024, 1024, 512),
        ("bfloat16", 32, 256, 8, 2048, 512, 8): (4, 512, 1024, 1024, 4, 512, 1024, 1024, 512),
        ("bfloat16", 64, 256, 8, 2048, 512, 8): (8, 512, 1024, 1024, 8, 512, 1024, 1024, 512),
        ("bfloat16", 128, 256, 8, 2048, 512, 8): (16, 512, 1024, 1024, 16, 512, 1024, 1024, 512),
        ("bfloat16", 256, 256, 8, 2048, 512, 8): (32, 512, 1024, 1024, 32, 512, 1024, 1024, 512),
        ("bfloat16", 512, 256, 8, 2048, 512, 8): (64, 512, 1024, 1024, 64, 512, 1024, 1024, 512),
        ("bfloat16", 1024, 256, 8, 2048, 512, 8): (128, 512, 1024, 1024, 128, 512, 1024, 1024, 512),
        ("bfloat16", 2048, 256, 8, 2048, 512, 8): (256, 512, 1024, 1024, 256, 512, 1024, 1024, 512),
        ("bfloat16", 4096, 256, 8, 2048, 512, 8): (512, 512, 1024, 1024, 512, 512, 1024, 1024, 512),
    },
