...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, int, int, int, int, int, int, int]]] = {
    ...
    "TPU v7": {
        # {'bt': 4, 'bf': 1024, 'bd1': 256, 'bd2': 256, 'btc': 4, 'bfc': 1024, 'bd1c': 256, 'bd2c': 256}
        # {'bt': 4, 'bf': 256, 'bd1': 8192, 'bd2': 8192, 'btc': 4, 'bfc': 256, 'bd1c': 8192, 'bd2c': 8192}
        ("bfloat16", 128, 256, 8, 8192, 2048, 32): (4, 256, 8192, 8192, 4, 256, 8192, 8192),
        # 'bt': 16, 'bf': 256, 'bd1': 8192, 'bd2': 8192, 'btc': 16, 'bfc': 256, 'bd1c': 8192, 'bd2c': 8192
        ("bfloat16", 4096, 256, 8, 8192, 2048, 32): (16, 256, 8192, 8192, 16, 256, 8192, 8192),
        ...
        # 'bt': 64, 'bf': 512, 'bd1': 4096, 'bd2': 4096, 'btc': 64, 'bfc': 512, 'bd1c': 4096, 'bd2c': 4096
        ("bfloat16", 4096, 256, 8, 8192, 2048, 4): (64, 512, 4096, 4096, 64, 512, 4096, 4096),
    },
