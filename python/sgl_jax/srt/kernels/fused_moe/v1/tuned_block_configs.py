...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, ...]]] = {
    ...
    "TPU v7": {
        ...
        # MiniMax-M3: 128 experts, top_k=4, H=6144, I=3072, ep=16, shared_expert, bf16 weight
        # Tuned on v7x-8 (2x2x2) 2026-06-16 @ sparse_hotspot 50%/16 (imbalance-tolerant, large bts)
        ('bfloat16', 'bfloat16', 32, 128, 4, 6144, 3072, 16, True, False): (2, 1024, 2048, 2048, 16, 16, 1024, 2048, 2048, 256),
        ('bfloat16', 'bfloat16', 64, 128, 4, 6144, 3072, 16, True, False): (4, 1024, 2048, 2048, 16, 16, 1024, 2048, 2048, 256),
        ('bfloat16', 'bfloat16', 256, 128, 4, 6144, 3072, 16, True, False): (16, 1024, 2048, 2048, 64, 64, 1024, 2048, 2048, 128),
        ('bfloat16', 'bfloat16', 1024, 128, 4, 6144, 3072, 16, True, False): (64, 1024, 1024, 1024, 64, 64, 1024, 1024, 1024, 512),
        ('bfloat16', 'bfloat16', 2048, 128, 4, 6144, 3072, 16, True, False): (128, 1024, 512, 512, 128, 128, 1024, 512, 512, 256),
        ('bfloat16', 'bfloat16', 8192, 128, 4, 6144, 3072, 16, True, False): (128, 1024, 512, 512, 128, 128, 1024, 512, 512, 256),
        # MiniMax-M3 ep=32 (v7x-16), tuned @ hotspot50 2026-06-16
        ('bfloat16', 'bfloat16', 64, 128, 4, 6144, 3072, 32, True, False): (2, 1024, 2048, 2048, 16, 16, 1024, 2048, 2048, 1024),
        ('bfloat16', 'bfloat16', 256, 128, 4, 6144, 3072, 32, True, False): (8, 1024, 2048, 2048, 64, 64, 1024, 2048, 2048, 256),
