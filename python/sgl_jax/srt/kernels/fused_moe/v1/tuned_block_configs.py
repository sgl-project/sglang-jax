...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, int, int, int, int, int, int, int]]] = {
    ...
    "TPU v7": {
        ...
        ("bfloat16", 128, 256, 8, 2048, 512, 8): (16, 512, 2048, 2048, 8, 512, 2048, 2048),
        ("bfloat16", 256, 256, 8, 2048, 512, 8): (32, 512, 2048, 2048, 16, 512, 2048, 2048),
        ("bfloat16", 512, 256, 8, 2048, 512, 8): (64, 512, 2048, 2048, 32, 512, 2048, 2048),
        ("bfloat16", 1024, 256, 8, 2048, 512, 8): (64, 512, 2048, 2048, 32, 512, 2048, 2048),
        ("bfloat16", 2048, 256, 8, 2048, 512, 8): (64, 512, 2048, 2048, 32, 512, 2048, 2048),
        ("bfloat16", 4096, 256, 8, 2048, 512, 8): (64, 512, 2048, 2048, 32, 512, 2048, 2048),
    },
