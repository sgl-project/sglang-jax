...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, int, int, int, int, int, int, int]]] = {
    ...
    "TPU v7": {
        ...
        ("bfloat16", 64, 256, 8, 8192, 2048, 32): (2, 1024, 4096, 4096, 2, 1024, 4096, 4096),
        ("bfloat16", 128, 256, 8, 8192, 2048, 32): (4, 1024, 4096, 4096, 4, 1024, 4096, 4096),
        ("bfloat16", 256, 256, 8, 8192, 2048, 32): (8, 1024, 2048, 2048, 8, 1024, 2048, 2048),
        ("bfloat16", 512, 256, 8, 8192, 2048, 32): (16, 512, 2048, 2048, 16, 512, 2048, 2048),
        ("bfloat16", 1024, 256, 8, 8192, 2048, 32): (16, 1024, 1024, 1024, 16, 1024, 1024, 1024),
        ("bfloat16", 2048, 256, 8, 8192, 2048, 32): (16, 512, 2048, 2048, 16, 512, 2048, 2048),
        ("bfloat16", 4096, 256, 8, 8192, 2048, 32): (16, 1024, 1024, 1024, 16, 1024, 1024, 1024),
    },
