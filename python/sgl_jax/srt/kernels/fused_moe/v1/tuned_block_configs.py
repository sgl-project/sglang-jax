...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, ...]]] = {
    ...
    "TPU v6e": {
        ...
        # FP8 (float8_e4m3fn weights, bfloat16 activations), tuned on v6e-16 with fori_loop kernel, 2026-04-09
        ...
        ('bfloat16', 'float8_e4m3fn', 128, 256, 8, 4096, 2048, 16, False, False): (8, 2048, 4096, 4096, 128, 8, 2048, 4096, 4096, 2048),
        ('bfloat16', 'float8_e4m3fn', 256, 256, 8, 4096, 2048, 16, False, False): (16, 2048, 4096, 4096, 32, 16, 2048, 4096, 4096, 2048),
        ('bfloat16', 'float8_e4m3fn', 512, 256, 8, 4096, 2048, 16, False, False): (16, 2048, 4096, 4096, 16, 16, 2048, 4096, 4096, 2048),
        ('bfloat16', 'float8_e4m3fn', 1024, 256, 8, 4096, 2048, 16, False, False): (64, 2048, 2048, 2048, 512, 64, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 2048, 256, 8, 4096, 2048, 16, False, False): (128, 2048, 1024, 1024, 512, 64, 2048, 1024, 1024, 2048),
        ('bfloat16', 'float8_e4m3fn', 4096, 256, 8, 4096, 2048, 16, False, False): (256, 1024, 2048, 2048, 128, 64, 1024, 2048, 2048, 1024),
        ('bfloat16', 'float8_e4m3fn', 8192, 256, 8, 4096, 2048, 16, False, False): (512, 512, 1024, 1024, 256, 256, 512, 1024, 1024, 512),
    },
