...
DISABLE_MULTINODE_TPU_SINGLE_TOKEN_PREFIX_CACHE = (
    os.environ.get("SGLANG_JAX_DISABLE_SINGLE_TOKEN_PREFIX_CACHE", "1") == "1"
)


def is_multinode_tpu_runtime() -> bool:
    return jax.process_count() > 1 and any(device.platform == "tpu" for device in jax.local_devices())
