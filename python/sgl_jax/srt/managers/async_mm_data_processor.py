...
class AsyncMMDataProcessor:
    ...
    def __init__(
        ...
        *,
        ...
        self.fallback_exec: ThreadPoolExecutor | None = (
            ThreadPoolExecutor(max_workers=max_concurrent_calls) if not self.is_async else None
        )
    ...
    async def process(
        ...
        *,
        ...
        audio_data: list[str | bytes] | None = None,
        input_text_or_ids: str | list[int] | None = None,
        request_obj: Any,
        **kwargs: Any,
    ) -> dict[str, Any]:
        """
    ...
    def shutdown(self) -> None:
        ...
        try:
            ...
            logger.exception("Error while shutting down fallback executor in AsyncMMDataProcessor")
