...
class Scheduler(
    ...
    def init_memory_pool_and_cache(self):
        ...
        components = (
            ...
            if component_values
            else (["FULL", "SWA"] if self.is_hybrid else ["FULL"])
        )
        logger.info(
    ...
    def check_memory(self):
        if self.is_hybrid:
            ...
            # only part of it, so validate the aggregate owner count against
            # the reserved-page bounds rather than requiring token equality.
