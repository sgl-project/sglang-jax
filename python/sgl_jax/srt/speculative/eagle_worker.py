...
class EAGLEWorker(BaseSpecWorker):
    ...
    def precompile_spec_extend(self):
        ...
        bs = self._get_spec_precompile_bs_buckets(candidates=[bs])[0]
        variants = self._get_spec_precompile_extend_variants(bs)

        def _compile(pair):
            padded_bs, num_tokens = pair
            per_dp_bs = padded_bs // dp_size
        ...
        self._run_spec_precompile_variants(
            ...
            variants,
            _compile,
            lambda pair: {"bs": pair[0], "tokens": pair[1], "dp_size": dp_size},
        )
    ...
    def precompile_spec_decode(self):
        ...
        def _compile(bs):
            ...
            spec_info = EagleDraftInput(
                ...
                allocate_lens=model_worker_batch.seq_lens + EagleDraftInput.ALLOC_LEN_PER_DECODE,
            )
            if self.spec_relay_buffers is not None:
        ...
        self._run_spec_precompile_variants(
            ...
            bs_buckets,
            _compile,
            lambda bs: {"bs": bs, "dp_size": dp_size},
        )
