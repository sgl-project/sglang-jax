...
from .sglang_grok_epmoe import EPMoE
from .sglang_grok_moe import FusedMoE
from .sglang_grok_router import fused_moe_router_shim
        ...
        if self.num_experts > 0:
            ...
            if self.residual_moe:
                self.mlp = Grok1MLP(
                    ...
                    param_dtype=config.torch_dtype,
                )
        else:
